...
\begin{tabular}{@{}lll@{}}
\cmidrule(r){1-3}
Variable name & Abbreviation & Description                                                                                          \\ \cmidrule(r){1-3}
Planet name   & P\_NAME      & \begin{tabular}[c]{@{}l@{}}The planet name according to \\ the international convention\end{tabular} \\
              &              &                                                                                                      \\
              &              &                                                                                                      \\
              &              &                                                                                                      \\
              &              &                                                                                                      \\
